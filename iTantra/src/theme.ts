...
export const TYPOGRAPHY = {
  display: { fontSize: 32, fontWeight: '700' as const, lineHeight: 40, letterSpacing: 0 },
  headline: { fontSize: 24, fontWeight: '700' as const, lineHeight: 32, letterSpacing: 0 },
  title: { fontSize: 18, fontWeight: '600' as const, lineHeight: 26, letterSpacing: 0 },
  titleSmall: { fontSize: 15, fontWeight: '600' as const, lineHeight: 22, letterSpacing: 0 },
